                ...
                <div id="modalConfig" class="fixed bg-black w-full h-full bg-opacity-50 hidden items-center justify-center z-20">
                    <div id="configBox"
                        ...
                        <div id="cancelarAlteracao" onclick="hiddeModalConfig()"
                            class="bg-red-500 text-white rounded-full w-6 h-6 text-center absolute top-2 right-2 cursor-pointer">x
                        </div>

                        <form action="/upload" method="put" enctype="multipart/form-data"
                            class="flex items-start justify-evenly h-full flex-col p-4 w-full">
                            ...
                            <label for="inputAlterarBanner"
                                ...
                                <div id="alterarBanner" class="w-full h-52 bg-cover bg-center"></div>
                                <p class="font-osvaldo text-white font-extralight text-lg">Alterar banner</p>
                                <input id="inputAlterarBanner" type="file" class="text-white font-osvaldo font-light hidden">
                            </label>
                            ...
                            <label for="inputAlterarPfp"
                                ...
                                <input id="inputAlterarPfp" type="file" class="text-white font-osvaldo font-light hidden">
                            </label>
